...
function Library:Notify(...)
    ...
    local FakeBackground = New("Frame", {
        ...
        BackgroundTransparency = 1,
        Size = UDim2.fromOffset(300 * Library.DPIScale, 0),
        Visible = false,
        Parent = NotificationArea,
    ...
    local ClosedPosition = IsLeft
        and UDim2.new(0, -316, 0, 0)
        or UDim2.new(0, 316, 0, 0)
    ...
    New("UICorner", {
        CornerRadius = UDim.new(0, math.max(6, Library.CornerRadius)),
        Parent = Background,
    })
    ...
    task.spawn(function()
        local Duration = math.max(0.1, Data.Time)
        ...
        if not FakeBackground.Parent then
            return
        end
...
function Library:CreateWindow(WindowInfo)
    ...
    function Library:Toggle(Value)
        ...
        if Library.Toggled then
            ...
            AnimScale.Scale = 0.86
            MainFrame.BackgroundTransparency = 0.4
            local openScale = TweenService:Create(AnimScale, TweenInfo.new(0.4, Enum.EasingStyle.Back, Enum.EasingDirection.Out), { Scale = 1 })
            local openFade = TweenService:Create(MainFrame, TweenInfo.new(0.3, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), { BackgroundTransparency = 0 })
            openScale:Play()
            openFade:Play()
            ...
            local closeScale = TweenService:Create(AnimScale, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.In), { Scale = 0.88 })
            local closeFade = TweenService:Create(MainFrame, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.In), { BackgroundTransparency = 0.45 })
            closeScale:Play()
            closeFade:Play()
            closeScale.Completed:Connect(function()
    ...
    if WindowInfo.AutoShow then
        ...
        MainFrame.Visible = true
        AnimScale.Scale = 0.88
        MainFrame.BackgroundTransparency = 0.3
        task.defer(function()
            TweenService:Create(AnimScale, TweenInfo.new(0.42, Enum.EasingStyle.Back, Enum.EasingDirection.Out), { Scale = 1 }):Play()
            TweenService:Create(MainFrame, TweenInfo.new(0.32, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), { BackgroundTransparency = 0 }):Play()
        end)
    end
...
function Library:ResetTheme()
    return Library:ApplyPreset("BlackAndWhite")
end
